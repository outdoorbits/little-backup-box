...
<link rel="icon" type="image/png" sizes="512x512" href="img/icons/favicon-512.png"/>
	<link rel="stylesheet" href="http://lbb.local/css/slideshow.css">
	<link rel="stylesheet" href="http://lbb.local/css/mglass.css">
	<script type="text/javascript" src="http://lbb.local/js/mglass.js"></script>
	<script type="text/javascript" src="http://lbb.local/js/slideshow.js"></script>
	<script type="text/javascript" src="js/display.js"></script>

</head>

<body  onload="refreshDisplay(); slideshow_init();">
		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="view.php#" id="navbarDropdownPower" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						<svg width="1em" height="1em" style="vertical-align: middle;">
							<use href="#icon-power"/>
						</svg>
					</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdownPower">
						<li><a class="dropdown-item" href="http://lbb.local/view.php?reboot=true">Reboot</a></li>
						<li><a class="dropdown-item" href="http://lbb.local/view.php?shutdown=true">Power off</a></li>
						<li><a class="dropdown-item" href="http://logout@lbb.local:80">Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
...
<!-- mastodon -->
<symbol id="icon-mastodon-nothing" viewBox="0 0 24 24" fill="none">
    <rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#dadada"/>
...
</symbol><symbol id="icon-mastodon-publish" viewBox="0 0 24 24" fill="none">
    <rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#ff6363"/>
    <g transform="translate(4,4)">
        <path d="M11.19 12.195c2.016-.24 3.77-1.475 3.99-2.603.348-1.778.32-4.339.32-4.339 0-3.47-2.286-4.488-2.286-4.488C12.062.238 10.083.017 8.027 0h-.05C5.92.017 3.942.238 2.79.765c0 0-2.285 1.017-2.285 4.488l-.002.662c-.004.64-.007 1.35.011 2.091.083 3.394.626 6.74 3.78 7.57 1.454.383 2.703.463 3.709.408 1.823-.1 2.847-.647 2.847-.647l-.06-1.317s-1.303.41-2.767.36c-1.45-.05-2.98-.156-3.215-1.928a4 4 0 0 1-.033-.496s1.424.346 3.228.428c1.103.05 2.137-.064 3.188-.189zm1.613-2.47H11.13v-4.08c0-.859-.364-1.295-1.091-1.295-.804 0-1.207.517-1.207 1.541v2.233H7.168V5.89c0-1.024-.403-1.541-1.207-1.541-.727 0-1.091.436-1.091 1.296v4.079H3.197V5.522q0-1.288.66-2.046c.456-.505 1.052-.764 1.793-.764.856 0 1.504.328 1.933.983L8 4.39l.417-.695c.429-.655 1.077-.983 1.934-.983.74 0 1.336.259 1.791.764q.662.757.661 2.046z" fill="#6364FF" stroke="none"/>
    </g>
</symbol><symbol id="icon-mastodon-published" viewBox="0 0 24 24" fill="none">
    <rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#7dfa75"/>
    <g transform="translate(4,4)">
        <path d="M11.19 12.195c2.016-.24 3.77-1.475 3.99-2.603.348-1.778.32-4.339.32-4.339 0-3.47-2.286-4.488-2.286-4.488C12.062.238 10.083.017 8.027 0h-.05C5.92.017 3.942.238 2.79.765c0 0-2.285 1.017-2.285 4.488l-.002.662c-.004.64-.007 1.35.011 2.091.083 3.394.626 6.74 3.78 7.57 1.454.383 2.703.463 3.709.408 1.823-.1 2.847-.647 2.847-.647l-.06-1.317s-1.303.41-2.767.36c-1.45-.05-2.98-.156-3.215-1.928a4 4 0 0 1-.033-.496s1.424.346 3.228.428c1.103.05 2.137-.064 3.188-.189zm1.613-2.47H11.13v-4.08c0-.859-.364-1.295-1.091-1.295-.804 0-1.207.517-1.207 1.541v2.233H7.168V5.89c0-1.024-.403-1.541-1.207-1.541-.727 0-1.091.436-1.091 1.296v4.079H3.197V5.522q0-1.288.66-2.046c.456-.505 1.052-.764 1.793-.764.856 0 1.504.328 1.933.983L8 4.39l.417-.695c.429-.655 1.077-.983 1.934-.983.74 0 1.336.259 1.791.764q.662.757.661 2.046z" fill="#6364FF" stroke="none"/>
    </g>
</symbol><symbol id="icon-mastodon-combined" viewBox="0 0 24 24" fill="none">
    <defs>
...
<!-- matrix -->
<symbol id="icon-matrix-nothing" viewBox="0 0 24 24" fill="none">
	<rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#dadada"/>
...
</symbol><symbol id="icon-matrix-publish" viewBox="0 0 24 24" fill="none">
	<rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#ff6363"/>
	<g stroke="#000" stroke-width="1.8" stroke-linecap="butt" stroke-linejoin="miter" fill="none">
		<!-- linke Klammer -->
		<path d="M4 5 h3 M4 5 v14 M4 19 h3" />
...
</symbol><symbol id="icon-matrix-published" viewBox="0 0 24 24" fill="none">
	<rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#7dfa75"/>
	<g stroke="#000" stroke-width="1.8" stroke-linecap="butt" stroke-linejoin="miter" fill="none">
		<!-- linke Klammer -->
		<path d="M4 5 h3 M4 5 v14 M4 19 h3" />
...
</symbol><symbol id="icon-matrix-combined" viewBox="0 0 24 24" fill="none">
	<defs>
	<linearGradient id="grad-bg" x1="0%" y1="100%" x2="100%" y2="0%">
	<stop offset="0%" stop-color="#7dfa75"/>
	<stop offset="50%" stop-color="#7dfa75"/>
...
<!-- telegram -->
<symbol id="icon-telegram-nothing" viewBox="0 0 24 24" fill="none">
  <rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#dadada"/>
  <g transform="translate(4,4)">
...
</symbol><symbol id="icon-telegram-publish" viewBox="0 0 24 24" fill="none">
  <rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#ff6363"/>
  <g transform="translate(4,4)">
    <path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995 3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 0-.154-.154l-.338-.215 7.494-7.494 1.178-.471z" fill="#FFFFFF" stroke="#229ED9" stroke-width="1.2" stroke-linejoin="round" stroke-linecap="round" vector-effect="non-scaling-stroke"/>
  </g>
</symbol><symbol id="icon-telegram-published" viewBox="0 0 24 24" fill="none">
  <rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#7dfa75"/>
  <g transform="translate(4,4)">
    <path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995 3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 0-.154-.154l-.338-.215 7.494-7.494 1.178-.471z" fill="#FFFFFF" stroke="#229ED9" stroke-width="1.2" stroke-linejoin="round" stroke-linecap="round" vector-effect="non-scaling-stroke"/>
  </g>
</symbol><symbol id="icon-telegram-combined" viewBox="0 0 24 24" fill="none">
  <defs>
	<linearGradient id="grad-bg" x1="0%" y1="100%" x2="100%" y2="0%">
	<stop offset="0%" stop-color="#7dfa75"/>
	<stop offset="50%" stop-color="#7dfa75"/>
...
<!-- bluesky -->
<symbol id="icon-bluesky-nothing" viewBox="0 0 24 24" fill="none">
	<rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#dadada"/>
	<g transform="translate(4,4)">
...
</symbol><symbol id="icon-bluesky-publish" viewBox="0 0 24 24" fill="none">
	<rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#ff6363"/>
	<g transform="translate(4,4)">
		<path d="M3.468 1.948C5.303 3.325 7.276 6.118 8 7.616c.725-1.498 2.698-4.29 4.532-5.668C13.855.955 16 .186 16 2.632c0 .489-.28 4.105-.444 4.692-.572 2.04-2.653 2.561-4.504 2.246 3.236.551 4.06 2.375 2.281 4.2-3.376 3.464-4.852-.87-5.23-1.98-.07-.204-.103-.3-.103-.218 0-.081-.033.014-.102.218-.379 1.11-1.855 5.444-5.231 1.98-1.778-1.825-.955-3.65 2.28-4.2-1.85.315-3.932-.205-4.503-2.246C.28 6.737 0 3.12 0 2.632 0 .186 2.145.955 3.468 1.948" fill="#5488f0" stroke="none"/>
	</g>
</symbol><symbol id="icon-bluesky-published" viewBox="0 0 24 24" fill="none">
	<rect x="2" y="2" width="20" height="20" rx="3" ry="3" fill="#7dfa75"/>
	<g transform="translate(4,4)">
		<path d="M3.468 1.948C5.303 3.325 7.276 6.118 8 7.616c.725-1.498 2.698-4.29 4.532-5.668C13.855.955 16 .186 16 2.632c0 .489-.28 4.105-.444 4.692-.572 2.04-2.653 2.561-4.504 2.246 3.236.551 4.06 2.375 2.281 4.2-3.376 3.464-4.852-.87-5.23-1.98-.07-.204-.103-.3-.103-.218 0-.081-.033.014-.102.218-.379 1.11-1.855 5.444-5.231 1.98-1.778-1.825-.955-3.65 2.28-4.2-1.85.315-3.932-.205-4.503-2.246C.28 6.737 0 3.12 0 2.632 0 .186 2.145.955 3.468 1.948" fill="#5488f0" stroke="none"/>
	</g>
</symbol><symbol id="icon-bluesky-combined" viewBox="0 0 24 24" fill="none">
	<defs>
	<linearGradient id="grad-bg" x1="0%" y1="100%" x2="100%" y2="0%">
	<stop offset="0%" stop-color="#7dfa75"/>
	<stop offset="50%" stop-color="#7dfa75"/>
...
<!-- FILTER -->
	<div class="card" style="margin-top: 2em">
		<details>
			<summary style="letter-spacing: 1px; text-transform: uppercase;">Filter</summary>
			<form action="view.php" method="POST">
				<input type="hidden" name="order_by" value="Create_Date">
				<input type="hidden" name="order_dir" value="DESC">
				<input type="hidden" name="gridcolumns" value="3">

				<div style="display: flow-root">
					<div style="float:left;padding: 5px;">
						<label for="filter_medium">Storage medium</label><br>

							<select name="filter_medium" id="filter_medium" onchange="this.form.submit()">
								<option value="target_usb" >USB target</option>
								<option value="source_usb" >USB source</option>
																<option value="internal"  selected>Int. storage</option>
							</select>
					</div>

					<div style="float:right;padding: 5px;">
						<label for="filter_images_per_page">Images per page</label><br>
							<select name="filter_images_per_page" id="filter_images_per_page" onchange="this.form.submit()">
							<option value="15" >15</option><option value="30"  selected>30</option><option value="60" >60</option><option value="150" >150</option><option value="300" >300</option>							</select>
					</div>
				</div>
...
See the <a href="https://github.com/outdoorbits/little-backup-box/wiki/05a.-view-image-viewer">Wiki</a> for more information.	</div>

	
<div class="footer">
	<form action="view.php" class="text-center" style="margin-top: 1em;" method="POST">
