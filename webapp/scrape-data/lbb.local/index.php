	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse w-50" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0  w-100">
				<li class="nav-item"><a class="nav-link active" href="index.php">Backup</a></li>
		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="index.php#" id="navbarDropdownPower" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						<svg width="1em" height="1em" style="vertical-align: middle;">
							<use href="#icon-power"/>
						</svg>
					</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdownPower">
						<li><a class="dropdown-item" href="http://lbb.local/index.php?reboot=true">Reboot</a></li>
						<li><a class="dropdown-item" href="http://lbb.local/index.php?shutdown=true">Power off</a></li>
...
<div class="footer">
	<form action="index.php" class="text-center" style="margin-top: 1em;" method="POST">
			<div class="card" style="margin-top: 3em;">
