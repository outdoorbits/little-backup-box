		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="setup.php#" id="navbarDropdownPower" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						<svg width="1em" height="1em" style="vertical-align: middle;">
							<use href="#icon-power"/>
						</svg>
					</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdownPower">
						<li><a class="dropdown-item" href="http://lbb.local/setup.php?reboot=true">Reboot</a></li>
						<li><a class="dropdown-item" href="http://lbb.local/setup.php?shutdown=true">Power off</a></li>
				...
				<h3>Hardware</h3>
					...
					<div>
						<label for="conf_MENU_BUTTON_COMBINATION">Please select a variant using the table (pins according to GPIO.BCM). Note: The display menu must also be activated. (Display menu)</label><br />
							...
							<a href="http://lbb.local/files/index.php?p=&amp;edit=buttons.private.cfg">Edit custom configuration file</a>
					</div>
...
rsync, however, can have advantages in the event of transfer interruptions, especially with large files.</p>
				...
				<h3>rclone GUI</h3>
					<a href="http://lbb.local/frame.php?page=rclone_gui" target="_blank">Open the rcloud GUI in a new window</a>
					<p>
		...
		<div class="card" style="margin-top: 2em;">
			<details>
				...
				<h3>Download</h3>
					...
					<a href="http://lbb.local/download-settings.php">Download settings</a>
...
Then connect to the "little-backup-box-nnnn" WiFi hotspot. Now you can reach commitup at <a href="http://10.41.0.1">http://10.41.0.1</a>. You can access the Little Backup Box WebUI here: <a href="https://10.41.0.1">https://10.41.0.1</a>.<br />
					<br />
					<a href='http://lbb.local/cmd.php?CMD=comitup_reset'>Delete WiFi credentials</a>
				</details>
			</div>
...
<!-- 				</ul> -->
				...
				<p>
					<a href="http://lbb.local/setup.php?check_update=true">Check for new update</a>
				</p>
