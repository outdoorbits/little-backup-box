		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="tools.php#" id="navbarDropdownPower" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						<svg width="1em" height="1em" style="vertical-align: middle;">
							<use href="#icon-power"/>
						</svg>
					</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdownPower">
						<li><a class="dropdown-item" href="http://lbb.local/tools.php?reboot=true">Reboot</a></li>
						<li><a class="dropdown-item" href="http://lbb.local/tools.php?shutdown=true">Power off</a></li>
