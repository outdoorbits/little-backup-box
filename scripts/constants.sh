...
const_MOUNTPOINT_SUBPATH_LOCAL_USB_TARGET="usb_target"
const_MOUNTPOINT_SUBPATH_LOCAL_USB_SOURCE="usb_source"
const_MOUNTPOINT_SUBPATH_LOCAL_NVME_TARGET="nvme_target"
const_MOUNTPOINT_SUBPATH_LOCAL_NVME_SOURCE="nvme_source"
