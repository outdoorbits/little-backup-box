		...
		return(
				{
					...
					'conf_BACKUP_TARGET_BASEDIR_CLOUD':				{'value': 'little-backup-box', 'type' : 'str'},
					...
					'conf_DISP_COLOR_TEXT':							{'value': 'white', 'type' : 'str'},
					'conf_DISP_COLOR_HIGH':							{'value': 'yellow', 'type' : 'str'},
					'conf_DISP_COLOR_ALERT':						{'value': 'red', 'type' : 'str'},
		...
		return(
				{
					...
					'const_MOUNTPOINT_SUBPATH_LOCAL_TARGET':		{'type': 'str'},
					...
					'const_STORAGE_DEV_MASK':						{'type': 'str'},
