...
<h2>NEWS</h2>
<ul>
	<li>2023/04/14: Introducing support for hardware-buttons including a display-menu to control a wide range of lbb's functions. Read more in the [Wiki](https://github.com/outdoorbits/little-backup-box/wiki/02a.-Displaymenu).</li>
